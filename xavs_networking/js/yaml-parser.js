...
const XAVSYAMLParser = {
  ...
  async generateYAML(configObject) {
    try {
      ...
      const yamlOutput = jsyaml.dump(configObject, options);
...
async function parseYamlFiles(filePaths) {
...
function getInterfaceOwnership(interfaceName, yamlInfo) {
...
window.XAVSYAMLParser = XAVSYAMLParser;
window.parseYamlFiles = parseYamlFiles;
window.checkInterfaceInConfig = checkInterfaceInConfig;
window.getInterfaceOwnership = getInterfaceOwnership;

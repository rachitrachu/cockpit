...
(() => {
  ...
  async function initialize() {
    ...
    try {
      ...
      if (!tableBody) {
        console.warn('⚠️ Interface table body not found, waiting...');
      ...
      console.log('🏗️ Setting up networking forms...');
      ...
      try {
        ...
        console.warn('⚠️ Failed to load connections:', error);
      }
      ...
      try {
        ...
        console.warn('⚠️ Failed to load diagnostics:', error);
      }
